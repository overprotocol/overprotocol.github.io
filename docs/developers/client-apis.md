...
`QUANTITY` - integer of the the `restoredEpoch` and `nonce` of this address.
...
// Result
{
    "jsonrpc": "2.0",
    "id": 79,
    "result": "0x200000003" // restoredEpoch = 2, nonce = 3
}
```
